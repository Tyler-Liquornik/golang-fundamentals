...
If you run go build in a module without any package main, Go will compile the code but won’t produce an executable, since only packages named `main` can be built into runnable programs.